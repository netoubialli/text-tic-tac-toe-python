...
def print_welcome_msg():
    ...
    print('1) You choose a symbol to play: O or X.')
    print_blank_line()
    print('2) A tic-tac-toe board will be shown to you containing the numbers from 1 to 9 representing each available position on the board, as follows.')
